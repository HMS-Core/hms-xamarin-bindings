...
namespace HmsXamarinMLDemo.MLKitActivities.TextRelated.GeneralCard
{
    ...
    {
        private const string Tag = "HomeCardProcess";
        ...
        public UniversalCardResult GetResult()
        {
            ...
            if (blocks.Count == 0)
            {
                Log.Info(HomeCardProcess.Tag, "HomeCardProcess::getResult blocks is empty");
                return null;
            }
            ...
            Log.Info(HomeCardProcess.Tag, "valid: " + valid);
            Log.Info(HomeCardProcess.Tag, "number: " + number);
        ...
        private IList<BlockItem> GetOriginItems(IList<MLText.Block> blocks)
        {
            ...
            foreach (MLText.Block block in blocks)
            {
                ...
                foreach (MLText.TextLine line in lines)
                {
                    ...
                    Log.Info("HomeCard", "HomeCardProcess text: " + text);
