...
#region XTranslate Workarounds
namespace Huawei.Hms.Mlsdk.Translate.Local.Download.Strategy
{
...
namespace Huawei.Hms.Mlsdk.Translate.Local
{
...
namespace Huawei.Hms.Mlsdk.Translate
{
    public partial class MLTranslateLanguage
    {
        //PROPERTY
        public async Task<System.Collections.Generic.ICollection<string>> GetCloudAllLanguagesAsync() => (System.Collections.Generic.ICollection<string>)await CloudAllLanguages.CastTask<JavaSet<Java.Lang.String>>();

        //PROPERTY
        public async Task<System.Collections.Generic.ICollection<string>> GetLocalAllLanguagesAsync() => (System.Collections.Generic.ICollection<string>)await LocalAllLanguages.CastTask<JavaSet<Java.Lang.String>>();

    }
}

namespace Huawei.Hms.Mlsdk.Translate.Cloud
{
    public partial class MLRemoteTranslator
    {
        //async Task<NAME> MyMethod(params) => await MyNativeMethod(params).CastTask<NAME>();
        public async Task<string> TranslateAsync(string text) =>
            (string)await AsyncTranslate(text).CastTask<Java.Lang.String>();
    }
}

namespace Huawei.Hms.Mlsdk.Translate.Local
{
    public partial class MLLocalTranslator
    {
        //async Task<NAME> MyMethod(params) => await MyNativeMethod(params).CastTask<NAME>();
        public async Task<string> TranslateAsync(string text) =>
            (string)await AsyncTranslate(text).CastTask<Java.Lang.String>();
        ...
        public async Task PreparedModelAsync() =>
            await PreparedModel().CastTask();

        //async Task MyMethod() => await MyNativeMethod().CastTask();
        public async Task PreparedModelAsync(Huawei.Hms.Mlsdk.Model.Download.MLModelDownloadStrategy strategy) =>
            await PreparedModel(strategy).CastTask();

        //async Task MyMethod() => await MyNativeMethod().CastTask();
        public async Task PreparedModelAsync(Huawei.Hms.Mlsdk.Model.Download.MLModelDownloadStrategy strategy, Huawei.Hms.Mlsdk.Model.Download.IMLModelDownloadListener listener) =>
            await PreparedModel(strategy, listener).CastTask();
    }
}
