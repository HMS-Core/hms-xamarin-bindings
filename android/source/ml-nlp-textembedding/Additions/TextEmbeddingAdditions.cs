...
namespace Huawei.Hms.Mlsdk.Textembedding
{
    public partial class MLTextEmbeddingAnalyzer
    {
        //async Task<NAME> MyMethod(params) => await MyNativeMethod(params).CastTask<NAME>();
        public async Task<Java.Lang.Object> AnalyseSentenceVectorAsync(string sentence) =>
             await AnalyseSentenceVector(sentence).CastTask<Java.Lang.Object>(); //float[]

        //async Task<NAME> MyMethod(params) => await MyNativeMethod(params).CastTask<NAME>();
        public async Task<float> AnalyseSentencesSimilarityAsync(string firstSentence, string secondSentence) =>
            (float) await AnalyseSentencesSimilarity(firstSentence, secondSentence).CastTask<Java.Lang.Float>();

        //async Task<IList<TYPE>> MyMethod(params) => await MyNativeMethod(params).CastTask<JavaList<TYPE>>();
        public async Task<Java.Lang.Object> AnalyseSimilarWordsAsync(string word, int similarNum) =>
             await AnalyseSimilarWords(word, similarNum).CastTask<Java.Lang.Object>(); //IList<string>

        //async Task<NAME> MyMethod(params) => await MyNativeMethod(params).CastTask<NAME>();
        public async Task<Java.Lang.Object> AnalyseWordVectorAsync(string word) =>
             await AnalyseWordVector(word).CastTask<Java.Lang.Object>(); //float[]

        //async Task<IList<TYPE>> MyMethod(params) => await MyNativeMethod(params).CastTask<JavaList<TYPE>>();
        public async Task<Java.Lang.Object> AnalyseWordVectorBatchAsync(System.Collections.Generic.ICollection<string> words) =>
             await AnalyseWordVectorBatch(words).CastTask<Java.Lang.Object>(); //IDictionary<string, float[]>

        //async Task<NAME> MyMethod(params) => await MyNativeMethod(params).CastTask<NAME>();
        public async Task<float> AnalyseWordsSimilarityAsync(string firstWord, string secondWord) =>
            (float)await AnalyseWordsSimilarity(firstWord, secondWord).CastTask<Java.Lang.Float>();

        //Property
        public async Task<MLVocabularyVersion> GetVocabularyVersion() => await VocabularyVersion.CastTask<MLVocabularyVersion>();
