...
namespace Huawei.Cloud.Base.Util
{
	...
	{
		// Metadata.xml XPath method reference: path="/api/package[@name='com.huawei.cloud.base.util']/class[@name='GenericData']/method[@name='entrySet' and count(parameter)=0]"
