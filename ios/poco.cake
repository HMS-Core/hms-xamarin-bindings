...
class Artifact : IEquatable<Artifact>
{
	...
	public Artifact (string id, string groupId,string nugetVersion, string minimunSupportedVersion, string csprojName = null, Artifact [] dependencies = null, PodSpec [] podSpecs = null, string [] extraPodfileLines = null, string [] samples = null)
	{
		ArtifactId = id;
		GroupId= groupId;
	...
	public override int GetHashCode()
	{
		int hashCode = ArtifactId.GetHashCode();
